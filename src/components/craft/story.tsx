      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1px_1.5fr] items-start gap-0">
          ...
          <div className="md:pr-16 mb-16 md:mb-0">
            ...
            <p ref={smallRef} className="leading-[0.86]" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.8rem, 6vw, 5.5rem)", color: "var(--craft-cream)",  letterSpacing: "var(--track-display)", opacity: 0 }}>SMALL</p>
            <p ref={batchRef} className="leading-[0.86]" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.8rem, 6vw, 5.5rem)", color: "var(--craft-orange)", letterSpacing: "var(--track-display)", opacity: 0 }}>BATCH.</p>
            <p ref={realRef}  className="leading-[0.86]" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.8rem, 6vw, 5.5rem)", color: "var(--craft-cream)",  letterSpacing: "var(--track-display)", opacity: 0 }}>REAL</p>
            <p ref={localRef} className="leading-[0.86]" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.8rem, 6vw, 5.5rem)", color: "var(--craft-orange)", letterSpacing: "var(--track-display)", opacity: 0 }}>LOCAL.</p>
